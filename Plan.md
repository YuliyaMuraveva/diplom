...
*Ожидаемый результат:*  Данные появляются в базе. Пользователь видит сообщение об успешной покупке
...
#### 3. Попытка оплаты с отклоненной карты:
* На странице сервиса нажать кнопку "Купить"
* Ввести данные отклоненной карты
* Нажать кнопку "Продолжить"

*Ожидаемый результат:*  Покупка не совершается. Пользователь видит сообщение об ошибке

#### 4. Попытка покупки в кредит с отклоненной карты:
* На странице сервиса нажать кнопку "Купить в кредит"
* Ввести данные отклоненной карты
* Нажать кнопку "Продолжить"
...
### План сдачи работ
* Автотесты: 15.04.2021
* Результаты прогона автотестов: 17.04.2021
* Отчет по автоматизации: 18.04.2021